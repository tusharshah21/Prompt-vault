          ...
          <div className="max-w-lg relative">
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Buy and sell prompts with end-to-end double encryption — ECIES + Fhenix FHE.
                The chain never sees your plaintext.
              </p>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white" />
              <span className="text-white text-[9px] font-mono">SEPOLIA · ECIES · FHE</span>
            </div>
          </div>
        </div>
      </div>
